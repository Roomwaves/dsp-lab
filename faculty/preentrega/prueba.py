"""Script de prueba para la preentrega."""
...
if __name__ == "__main__":
    ...
    y_media, _ = filtro_media_movil(señal_entrada, m=20, p=2)
    y_peine = filtro_peine(señal_entrada, a=0.1, b=0.5, c=0.4)
    y_fir, _ = filtro_fir(señal_entrada)

    print("Prueba completada correctamente en prueba.py.")
